...
public class Room {
    ...
    /**
     * Prints the description, exits, and items contained within this Room.
     */
     ...
     * @return true if {@code o == this} or {@code o} is a Room and {@code o.name} {@link String#equals equals} {@code this.name}, false otherwise
     */
    @Override
